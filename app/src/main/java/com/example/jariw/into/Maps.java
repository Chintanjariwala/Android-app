...
public class Maps extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng marshall = new LatLng(38.423975, -82.426694);
        mMap.addMarker(new MarkerOptions().position(marshall).title("INTO Marshall")
        );
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(marshall, 17));
        ...
        rightNavigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                if (id == R.id.nav_hospital) {
                    ...
                    mMap.clear();
                    String url = getUrl(38.423975, -82.426694, Hospital);
                    ...
                    Toast.makeText(Maps.this,"Nearby Hospital", Toast.LENGTH_LONG).show();


                } else if (id == R.id.nav_paring) {
                    String Parking = "parking";
                    Log.d("onClick", "Button is Clicked");
                    mMap.clear();
                    String url = getUrl(338.423975, -82.426694, Parking);
                    Object[] DataTransfer = new Object[2];
                    DataTransfer[0] = mMap;
                    DataTransfer[1] = url;
                    Log.d("onClick", url);
                    GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData();
                    getNearbyPlacesData.execute(DataTransfer);
                    Toast.makeText(Maps.this,"Nearby Parking", Toast.LENGTH_LONG).show();
                    ...
                    Log.d("onClick", "Button is Clicked");
                    mMap.clear();
                    String url = getUrl(38.423975, -82.426694, Restaurant);
                    Object[] DataTransfer = new Object[2];
                    DataTransfer[0] = mMap;
                    DataTransfer[1] = url;
                    Log.d("onClick", url);
                    GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData();
                    getNearbyPlacesData.execute(DataTransfer);
                    Toast.makeText(Maps.this,"Nearby Restaurant", Toast.LENGTH_LONG).show();
    ...
    public void onLocationChanged(Location location) {
        ...
        Toast.makeText(Maps.this,"Your Current Location", Toast.LENGTH_LONG).show();
